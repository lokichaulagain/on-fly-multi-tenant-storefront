...
export default function Page() {
  ...
  return (
    <div>
      ...
      />
      <div className="w-full md:w-9/12 mx-auto px-4 pt-8   space-y-20">
        <div className=" grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="max-w-lg space-y-3">
            <h3 className="text-primary-400 font-semibold">Contact</h3>
            <p className="text-secondary-900 text-3xl font-semibold sm:text-4xl">
              Let us know how <span className=" text-primary-400">we can help</span>
            </p>
            <p className=" text-secondary-600 tracking-wide leading-relaxed">We’re here to help and answer any question you might have, We look forward to hearing from you! Please fill out the form, or us the contact information bellow .</p>
            <div>
              <ul className="mt-6 flex flex-wrap gap-x-10 gap-y-6 items-center">
                {contactMethods.map((item, idx) => (
                  <li
                    ...
                    <div className="flex-none text-secondary-800">{item.icon}</div>
                    <p className="text-secondary-800">{item.contact}</p>
                  </li>
                ))}
              </ul>
            </div>
