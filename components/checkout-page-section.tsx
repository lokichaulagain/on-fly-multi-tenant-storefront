            ...
            <form
              ...
              {isSignedIn ? (
                ...
                <SignInButton
                  ...
                  <Button className="w-full bg-[var(--secondary)] hover:bg-[var(--secondary)] text-white">Sign In</Button>
                </SignInButton>
              )}
            </form>
          </Form>
...
function EmptyCart() {
  return (
    <div className="flex flex-col items-center justify-center text-center">
      ...
      <p className="text-sm text-muted-foreground mb-1">Your cart is empty. Add some products to your cart to checkout.</p>
      <Link href="/shop">
        <Button className=" bg-[var(--secondary)] hover:bg-[var(--secondary)]">Shop Now</Button>
      </Link>
    </div>
  );
}
